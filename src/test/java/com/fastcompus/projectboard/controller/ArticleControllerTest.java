...
import com.fastcompus.projectboard.config.TestSecurityConfig;
import com.fastcompus.projectboard.domain.constant.FormStatus;
...
import com.fastcompus.projectboard.service.ArticleService;
import com.fastcompus.projectboard.service.PageinationService;
import com.fastcompus.projectboard.util.FormDataEncoder;
...
class ArticleControllerTest {
    ...
    @MockBean
    private PageinationService pageinationService;
    ...
    public void givenNothing_whenRequestingArticlesView_thenReturnsArticlesView() throws Exception {
        ...
        given(pageinationService.getPaginationBarNumbers(anyInt(), anyInt())).willReturn(List.of(0, 1, 2, 3, 4));
    ...
    void givenPagingAndSortingParams_whenSearchingArticlesView_thenReturnsArticlesView() throws Exception {
        ...
        given(pageinationService.getPaginationBarNumbers(pageable.getPageNumber(), Page.empty().getTotalPages())).willReturn(barNumbers);
        ...
        then(pageinationService).should().getPaginationBarNumbers(pageable.getPageNumber(), Page.empty().getTotalPages());
    }
    ...
    public void givenNothing_whenRequestingArticleSearchHashtagView_thenReturnsArticleSearchHashtagView() throws Exception {
        ...
        given(pageinationService.getPaginationBarNumbers(anyInt(), anyInt())).willReturn(List.of(1, 2, 3, 4, 5));
