package com.fastcompus.projectboard.dto.security;
...
public record KakaoOAuth2Response(Long id, LocalDateTime connectedAt, Map<String, Object> properties, KakaoAccount kakaoAccount) {
    ...
    public record KakaoAccount(Boolean profileNicknameNeedsAgreement, Profile profile, Boolean hasEmail, Boolean EmailNeedsAgreement, Boolean isEmailValid, Boolean isEmailVerified, String email) {
