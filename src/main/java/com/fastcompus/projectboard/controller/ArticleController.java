...
import com.fastcompus.projectboard.dto.response.ArticleWithCommentsResponse;
...
public class ArticleController {
    ...
    private final PageinationService pageinationService;
    ...
    public String articles(
        ...
        List<Integer> barNumbers = pageinationService.getPaginationBarNumbers(pageable.getPageNumber(), articles.getTotalPages());
